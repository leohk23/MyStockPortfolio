...
- **Totals + a NAV chart** with 1D/7D/1M/3M/6M/YTD/12M/2Y/5Y/All ranges and a hover crosshair. **7D** is the last five sessions — one trading week — off the same daily closes as the longer ranges, so its headline agrees with the table's 7D column. (1D is intraday and single-stock only: a portfolio spanning Tokyo to New York has no one intraday timeline.) Portfolio "All" begins at the first recorded trade; individual stocks retain their full available price history.
